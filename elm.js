...
Elm.Datastructures = Elm.Datastructures || {};
Elm.Datastructures.Queue = Elm.Datastructures.Queue || {};
Elm.Datastructures.Queue.make = function (_elm) {
   "use strict";
   _elm.Datastructures = _elm.Datastructures || {};
   _elm.Datastructures.Queue = _elm.Datastructures.Queue || {};
   if (_elm.Datastructures.Queue.values)
   return _elm.Datastructures.Queue.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toList = function (_p0) {
      var _p1 = _p0;
      return A2($Basics._op["++"],_p1._0,$List.reverse(_p1._1));
   };
   var fromList = function (l) {
      return {ctor: "_Tuple2",_0: l,_1: _U.list([])};
   };
   var map = F2(function (f,_p2) {
      var _p3 = _p2;
      return {ctor: "_Tuple2"
             ,_0: A2($List.map,f,_p3._0)
             ,_1: A2($List.map,f,_p3._1)};
   });
   var foldl = F3(function (f,acc,_p4) {
      var _p5 = _p4;
      return A3($List.foldr,f,A3($List.foldl,f,acc,_p5._1),_p5._0);
   });
   var foldr = F3(function (f,acc,_p6) {
      var _p7 = _p6;
      return A3($List.foldl,f,A3($List.foldr,f,acc,_p7._0),_p7._1);
   });
   var length = function (_p8) {
      var _p9 = _p8;
      var outqueue_len = $List.length(_p9._1);
      var inqueue_len = $List.length(_p9._0);
      return inqueue_len + outqueue_len;
   };
   var dequeue = function (_p10) {
      dequeue: while (true) {
         var _p11 = _p10;
         var _p15 = _p11._1;
         var _p14 = _p11._0;
         ...
         if (_p12.ctor === "[]") {
               ...
               if (_p13.ctor === "[]") {
                     return {ctor: "_Tuple2"
                            ,_0: $Maybe.Nothing
                            ,_1: {ctor: "_Tuple2",_0: _p14,_1: _p15}};
                  } else {
                     var _v8 = {ctor: "_Tuple2"
                               ,_0: _U.list([])
                               ,_1: $List.reverse(_p14)};
                     _p10 = _v8;
                     continue dequeue;
                  }
            } else {
               return {ctor: "_Tuple2"
                      ,_0: $Maybe.Just(_p12._0)
                      ,_1: {ctor: "_Tuple2",_0: _p14,_1: _p12._1}};
            }
      }
   };
   var enqueue = F2(function (a,_p16) {
      var _p17 = _p16;
      return {ctor: "_Tuple2"
             ,_0: A2($List._op["::"],a,_p17._0)
             ,_1: _p17._1};
   });
   var init = {ctor: "_Tuple2",_0: _U.list([]),_1: _U.list([])};
   return _elm.Datastructures.Queue.values = {_op: _op
                                             ,init: init
                                             ,enqueue: enqueue
                                             ,dequeue: dequeue
                                             ,length: length
...
Elm.TimesTable = Elm.TimesTable || {};
Elm.TimesTable.make = function (_elm) {
   "use strict";
   _elm.TimesTable = _elm.TimesTable || {};
   if (_elm.TimesTable.values) return _elm.TimesTable.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Datastructures$Queue = Elm.Datastructures.Queue.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var timesTableView = function (model) {
      var mul = F2(function (x,y) {
         ...
         A2($Basics._op["++"],
         $Basics.toString(y),
         A2($Basics._op["++"]," is ",$Basics.toString(x * y)))));
      });
      return A2($Html.ul,
      _U.list([]),
      A2($List.map,
      function (y) {
         return A2($Html.li,
         _U.list([]),
         _U.list([$Html.text(A2(mul,model.currentBase,y))]));
      },
      _U.range(1,20)));
   };
   var timesTable = function (base) {
      var mul = F2(function (x,y) {
         return A2($Basics._op["++"],
         $Basics.toString(x),
         A2($Basics._op["++"],
      ...
      return A2($List.map,mul(base),_U.range(1,20));
   };
   var togglePause = function (model) {
      return _U.update(model,
      {paused: $Basics.not(model.paused),sayNow: ""});
   };
   var setBase = F2(function (base,model) {
      var tt = timesTable(base);
      var q = A3($List.foldl,
      $Datastructures$Queue.enqueue,
      $Datastructures$Queue.init,
      tt);
      return _U.update(model,{currentBase: base,sayQueue: q});
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Pause": return {ctor: "_Tuple2"
                            ,_0: togglePause(model)
                            ,_1: $Effects.none};
         case "Increment": return {ctor: "_Tuple2"
                                  ,_0: A2(setBase,model.currentBase + 1,model)
                                  ,_1: $Effects.none};
         case "Decrement": return {ctor: "_Tuple2"
                                  ,_0: A2(setBase,model.currentBase - 1,model)
                                  ,_1: $Effects.none};
         default:
         var _p1 = $Datastructures$Queue.dequeue(model.sayQueue);
           var top = _p1._0;
           var q = _p1._1;
           var result = function () {
              var _p2 = top;
              if (_p2.ctor === "Nothing") {
                    var next = _U.cmp(model.currentBase,
                    40) < 0 ? model.currentBase + 1 : 7;
                    return {ctor: "_Tuple2"
                           ,_0: A2(setBase,next,model)
                           ,_1: $Effects.none};
                 } else {
                    return {ctor: "_Tuple2"
                           ,_0: _U.update(model,{sayQueue: q,sayNow: _p2._0})
                           ,_1: $Effects.none};
                 }
           }();
           var _p3 = model.paused;
           if (_p3 === true) {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{sayNow: ""})
                        ,_1: $Effects.none};
              } else {
                 return result;
              }}
   });
   var SpeechDone = {ctor: "SpeechDone"};
   var ticker = A2($Signal.map,
   $Basics.always(SpeechDone),
   $Time.every(5 * $Time.second));
   var speechDone = A2($Signal.map,
   $Basics.always(SpeechDone),
   reset);
   var startSpeech = $Effects.task($Task.succeed(SpeechDone));
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html$Events.onClick,address,Pause)]),
              _U.list([$Html.text("Pause")]))]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.button,
                      ...
                      ,A2($Html.div,
                      _U.list([countStyle]),
                      _U.list([$Html.text($Basics.toString(model.currentBase))]))
                      ,A2($Html.button,
   ...
   var Model = F4(function (a,b,c,d) {
      return {currentBase: a,paused: b,sayQueue: c,sayNow: d};
   });
   var init = A4(Model,
   7,
   true,
   ...
   var app = $StartApp.start({init: {ctor: "_Tuple2"
                                    ,_0: A2(setBase,7,init)
                                    ,_1: $Effects.none}
                             ,update: update
                             ,view: view
                             ,inputs: _U.list([speechDone])});
   var smud = Elm.Native.Port.make(_elm).outboundSignal("smud",
   function (v) {
      return v;
   },
   A3($Signal.filter,
   ...
   "",
   A2($Signal.map,function (_) {    return _.sayNow;},app.model)));
   var baseValue = Elm.Native.Port.make(_elm).outboundSignal("baseValue",
   function (v) {
      return v;
   },
   $Signal.dropRepeats(A2($Signal.map,
   function (_) {
      return _.currentBase;
   },
   app.model)));
   var pauseState = Elm.Native.Port.make(_elm).outboundSignal("pauseState",
   function (v) {
      return v;
   },
   $Signal.dropRepeats(A2($Signal.map,
   ...
   app.model)));
   var main = app.html;
   return _elm.TimesTable.values = {_op: _op
                                   ,Model: Model
                                   ,init: init
                                   ,Increment: Increment
                                   ,Decrement: Decrement
